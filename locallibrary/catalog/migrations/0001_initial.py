# Generated by Django 5.2.2 on 2026-02-02 11:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Enter a brief '
                                             'description of the book',
                                             max_length=1000)),
                ('isbn', models.CharField(help_text='13 '
                '                            Character <a '
                                          'href="https://www.isbn-'
                                          'international.org/'
                                          'content/what-isbn">ISBN number</a>',
                                             max_length=13, unique=True, verbose_name='ISBN')),
                ('author', models.ForeignKey(null=True, on_delete=django.
                                             db.models.deletion.RESTRICT, to='catalog.author')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter the written langauge of the book (e.g. Spanish, French etc.)', max_length=20, unique=True)),
            ],
            options={
                'constraints': [models.UniqueConstraint(django
                                                        .db.models.functions.text.Lower('name'),
